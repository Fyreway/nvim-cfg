...
-- Help
vim.keymap.set('n', '<Leader>h', '<Cmd>vert h ', {noremap = true})

-- Create, move between, and delete buffers
vim.keymap.set('n', '<Leader><Tab>', '<Cmd>bn<Return>', {noremap = true, silent = true})
vim.keymap.set('n', '<Leader><S-Tab>', '<Cmd>bp<Return>', {noremap = true, silent = true})
...
-- File browser
vim.keymap.set('n', '<Leader>fb', '<Cmd>Telescope file_browser<Return>', {noremap = true, silent = true})
